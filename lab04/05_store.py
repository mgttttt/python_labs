...
for key, value in goods.items():
    result_count, result_price = 0, 0
    for dict in store[value]:
        result_count += dict['quantity']
        result_price += dict['quantity'] * dict['price']
    print(key, '-', result_count, 'шт, стоимость', result_price, 'руб')
